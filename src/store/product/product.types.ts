export enum PRODUCT_ACTION_TYPES {
  ...
  DELETE_ALL_PRODUCT_START = 'DELETE_ALL_PRODUCT_START',
  DELETE_ALL_PRODUCT_SUCCESS = 'DELETE_ALL_PRODUCT_SUCCESS',
  DELETE_ALL_PRODUCT_FAILED = 'DELETE_ALL_PRODUCT_FAILED',
}
